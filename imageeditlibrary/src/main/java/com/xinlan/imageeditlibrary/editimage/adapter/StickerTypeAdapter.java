...
public class StickerTypeAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static final String[] stickerPathName = {"动物", "心情", "cos", "符号",
            "饰品", "春节", "文字", "数字", "边框", "职业"};*/
    public static final int[] typeIcon = {R.drawable.stickers_type_round,R.drawable.stickers_type_rect,R.drawable.stickers_type_arrow};
    public static final String[] stickerPath = {"stickers/round",
            "stickers/rectangle", "stickers/arrow"};
    public static final String[] stickerPathName = {"圆型", "方框", "箭头"};
