...
import com.xinlan.imageeditlibrary.editimage.CropImageActivity;
...
public class MyCropFragment extends Fragment {
	...
	public static final String TAG = MyCropFragment.class.getName();
	private View mainView;
	private CropImageActivity activity;
	...
	public static MyCropFragment newInstance(CropImageActivity activity) {
		MyCropFragment fragment = new MyCropFragment();
