...
public class CheckReceptionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    List<CheckReceData> preorderDataList;
    Context context;
    OnItemClickListener onItemClickListener;
    OnChooseListener onChooseListener;

    public interface OnItemClickListener{
        void onItemClick(CheckReceData preorderData, int pos);
    }
    ...
    public CheckReceptionAdapter(Context context, List<CheckReceData> undealPreorderDataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if(viewType == -1){
            View view = View.inflate(context,R.layout.item_checkrece_choose,null);
            ...
            View view = View.inflate(context,R.layout.item_checkrece,null);
    ...
    public int getItemViewType(int position) {
        CheckReceData preorderData = preorderDataList.get(position);
    ...
    class TypeOneHolder extends RecyclerView.ViewHolder{
        ...
        public TypeOneHolder(View itemView) {
            super(itemView);
            itemChooseView = (ItemChooseView)itemView.findViewById(R.id.item_check_rece_choose);
    ...
    public void updateDatas(List<CheckReceData> updateList){
        compareData(preorderDataList,updateList);
        preorderDataList = updateList;
        notifyItemRangeChanged(1,updateList.size());
    }
    private void compareData(List<CheckReceData> oldDatas,List<CheckReceData> newDatas){
