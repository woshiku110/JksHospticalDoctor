 ...
 */
public class BloodDialog  extends PopupWindow {
    View view,parent;
    Context context;
    ...
    public interface BloodListener{
        void bloodType(String bloodType);
    }

    public BloodDialog setBloodListener(BloodListener bloodListener) {
        this.bloodListener = bloodListener;
        return this;
    }

    public BloodDialog(Context context, View parent) {
        ...
        btOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(bloodListener != null){
                    if(typeValue == 0){
                        bloodListener.bloodType("A");
                    }else if(typeValue == 1){
                        bloodListener.bloodType("B");
                    }else if(typeValue == 2){
                        bloodListener.bloodType("AB");
                    }else{
                        bloodListener.bloodType("O");
                    }
                }
                dismiss();
            }
    ...
    private void initViews(){
        bloodWheel = configWheelView(new TestAdapter(context,R.layout.item_sex,R.id.item_sex,bloodList),(LinearLayout)view.findViewById(R.id.line_sex));
